...
import styles from "../../assets/styles/login/_formLogin.module.sass";
        ...
        <>
            <form
                ...
                <div className={styles.returnToRegister}>
                    ...
                    <Link
                        className={styles.returnToRegisterLink}
                        to="/register">
                        Sign up
                    </Link>
                </div>
